...
function addroom4(){
"use strict";
	$('.room4').addClass('block');
	$('.room4').removeClass('none');
	
	$('.addroom3').removeClass('block');
	$('.addroom3').addClass('none');
}
function removeroom4(){
"use strict";
	$('.room4').addClass('none');
	$('.room4').removeClass('block');
	
	$('.addroom3').removeClass('none');
	$('.addroom3').addClass('block');			
}
